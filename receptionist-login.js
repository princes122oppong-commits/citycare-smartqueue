const staffLoginForm = document.getElementById("receptionistLoginForm");
const staffEmailInput = document.getElementById("receptionistEmail");
const staffPasswordInput = document.getElementById("receptionistPassword");
const staffEmailError = document.getElementById("receptionistEmailError");
const staffPasswordError = document.getElementById("receptionistPasswordError");
const toggleStaffPassword = document.getElementById("togglereceptionistPassword");
